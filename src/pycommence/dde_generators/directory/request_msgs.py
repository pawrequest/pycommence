...
def clarify_item_names(status: bool | None = None) -> DDEMessage:
    """
...
def get_caller_id(category: str | None, phone_number: str, delim: str = DELIM) -> DDEMessage:
...
def get_item_names(category: str, delim: str | None = DELIM) -> DDEMessage:
...
def get_mark_item(category: str, item: str, clarify_value: str | None = None) -> DDEMessage:
    """
...
def get_reverse_name(name: str, pref_flag: int | None = None) -> DDEMessage:
...
def get_view_count(category: str | None = None) -> DDEMessage:
    return DDEMessage(func_name='GetViewCount', params=[category])


def get_view_names(category: str | None = None, delim: str = DELIM) -> DDEMessage:
