...
def view_view(view_name: str | None = None) -> DDEMessage:
...
def view_item_index(name_field_value: str | None = None) -> DDEMessage:
...
def view_save_view(new_view_name: str, shared: str | None = None) -> DDEMessage:
    """
