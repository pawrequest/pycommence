...
from . import cursor, pycommence_types
...
class PyCommence(_p.BaseModel):
    ...
    def delete_record(self, pk_val: str, empty: pycommence_types.EmptyKind = 'raise'):
        """
        Delete a record.
    ...
    def delete_multiple(
            ...
            *,
            ...
            empty: pycommence_types.EmptyKind = 'raise'
    ):
        """
    ...
    def add_record(
        ...
        with self.csr.temporary_filter_pk(pk_val, empty='ignore'):  # noqa: PyArgumentList
            if not self.csr.row_count:
                ...
                if existing == 'raise':
                    raise pycommence_types.CmcError('Record already exists')
